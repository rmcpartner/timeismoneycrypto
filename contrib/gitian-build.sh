...
Run this script from the directory containing the timeismoney, gitian-builder, gitian.sigs, and timeismoney-detached-sigs.
...
then
	# Make output folder
	mkdir -p ./timeismoney-binaries/${VERSION}
