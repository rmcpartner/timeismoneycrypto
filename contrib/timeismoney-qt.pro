...
RESOURCES += src/qt/timeismoney.qrc src/qt/timeismoney_locale.qrc

TRANSLATIONS += src/qt/locale/timeismoney_bg.ts \
                src/qt/locale/timeismoney_de.ts \
                src/qt/locale/timeismoney_en.ts \
                src/qt/locale/timeismoney_es.ts \
                src/qt/locale/timeismoney_fi.ts \
                src/qt/locale/timeismoney_fr.ts \
                src/qt/locale/timeismoney_it.ts \
                src/qt/locale/timeismoney_ja.ts \
                src/qt/locale/timeismoney_pl.ts \
                src/qt/locale/timeismoney_pt.ts \
                src/qt/locale/timeismoney_ru.ts \
                src/qt/locale/timeismoney_sk.ts \
                src/qt/locale/timeismoney_sv.ts \
                src/qt/locale/timeismoney_vi.ts \
                src/qt/locale/timeismoney_zh_CN.ts \
                src/qt/locale/timeismoney_zh_TW.ts
