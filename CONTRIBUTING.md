Contributing to TimeIsMoney Core
============================

The TimeIsMoney Core project operates an open contributor model where anyone is
...
The following applies to code changes to the TimeIsMoney Core project, and is not to be
confused with overall TimeIsMoney Network Protocol consensus changes.

Whether a pull request is merged into TimeIsMoney Core rests with the project merge
...
Patches that change TimeIsMoney consensus rules are considerably more involved than
...
Where a patch set proposes to change the TimeIsMoney consensus, it must have been
...
The project leader is the release manager for each TimeIsMoney Core release.
