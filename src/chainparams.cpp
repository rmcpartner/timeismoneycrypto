...
static Checkpoints::MapCheckpoints mapCheckpoints =
	...
	(0, uint256("0x000006492c1db4ad056d32f12887391b5f37aff969802c27fa97543dcfc4202c"));
	
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1534706167, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 23007;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // TimeIsMoney starting difficulty is 1 / 2^12
        nSubsidyHalvingInterval = 0;
        nMaxReorganizationDepth = 100;
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // TimeIsMoney: 1 minute
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1534706167;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 365801;
		
        hashGenesisBlock = genesis.GetHash();
		
        assert(hashGenesisBlock == uint256("0x000006492c1db4ad056d32f12887391b5f37aff969802c27fa97543dcfc4202c"));
        assert(genesis.hashMerkleRoot == uint256("0x205092ed557e263223de21469f1bec5c95762e6d8a5d0ceded1926917f772193"));

		vSeeds.push_back(CDNSSeedData("1","37.252.1.48"));
        vSeeds.push_back(CDNSSeedData("1","91.235.136.218"));
        vSeeds.push_back(CDNSSeedData("2","194.1.236.245"));
		vSeeds.push_back(CDNSSeedData("2","37.1.215.223"));
        ...
        strObfuscationPoolDummyAddress = "TuTiiip8EATVj9Sr3KEBrojbrWCyN46UPN";
...
public:
    CTestNetParams()
    {
        ...
        nDefaultPort = 123007;
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // TimeIsMoney: 1 day
        nTargetSpacing = 1 * 60;  // TimeIsMoney: 1 minute
        nLastPOWBlock = 2000;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet timeismoney addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet timeismoney script addresses start with '8' or '9'
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // TimeIsMoney: 1 day
        nTargetSpacing = 1 * 60;        // TimeIsMoney: 1 minutes
