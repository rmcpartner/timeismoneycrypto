...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("TimeIsMoney Core"),
     ...
     * override -datadir in the timeismoney.conf file in the default data directory
     * (to be consistent with timeismoneyd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
