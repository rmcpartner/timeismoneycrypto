...
/** Utility functions used by the TimeIsMoney Qt UI.
 */
namespace GUIUtil
{
...
// Render TimeIsMoney addresses in monospace font
...
// Parse "timeismoney:" URI into recipient object, return true on successful parsing
