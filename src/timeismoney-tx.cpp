...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("TimeIsMoney Core timeismoney-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  timeismoney-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded timeismoney transaction") + "\n" +
                               "  timeismoney-tx [options] -create [commands]   " + _("Create hex-encoded timeismoney transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded timeismoney transaction
