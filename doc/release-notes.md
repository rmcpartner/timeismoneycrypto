TimeIsMoney Core version 2.2.1 is now available from:

  <https://github.com/timeismoney-project/timeismoney/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/timeismoney-project/timeismoney/issues>

Compatibility
==============

TimeIsMoney Core is extensively tested on multiple operating systems using
...
TimeIsMoney Core should also work on most other Unix-like systems but is not
...
of Bitcoin that TimeIsMoney was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/timeismoney-project-translations/).
