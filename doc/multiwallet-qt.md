...
In order to support loading of multiple wallets in timeismoney-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is timeismoney.cpp.
...
Changes to timeismoney.cpp
-------------------

timeismoney.cpp is the entry point into timeismoney-qt, and as such, will require some minor modifications to provide hooks for
